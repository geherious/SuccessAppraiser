...
{
    /// <inheritdoc />
    public partial class RefreshTokenTime : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayStates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DayStateGoalTemplate_DayStates_StatesId",
                        column: x => x.StatesId,
                        principalTable: "DayStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DaysNumber = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoalItems_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoalItems_GoalTemplates_TemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoalDates_DayStates_StateId",
                        column: x => x.StateId,
                        principalTable: "DayStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoalDates_GoalItems_GoalId",
                        column: x => x.GoalId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoalItems_TemplateId",
                table: "GoalItems",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_GoalItems_UserId",
                table: "GoalItems",
                column: "UserId");
